...
/**
 * Repositorio de JPA para la entidad Link, que gestiona las operaciones de base de datos relacionadas con las relaciones de seguimiento.
 */
public interface LinkRepository extends JpaRepository<Link, Long> {

	/**
	 * Consulta personalizada para buscar una relación de seguimiento por el identificador del usuario seguido y del usuario seguidor.
	 *
