package jajm.apitwitter.webapp.persistence.model;
 ...
 * Implementa la interfaz UserDetails de Spring Security para integrarse con la autenticación y autorización.
 */
@Getter
@Setter
@Builder
...
public class User implements UserDetails {
	...
	/**
	 * Implementación de la interfaz UserDetails de Spring Security para integrarse con la autenticación y autorización.
	 */
	@Override
	public Collection<? extends GrantedAuthority> getAuthorities() {
		// Retorna una lista con los roles del usuario, representados como instancias de SimpleGrantedAuthority.
		return List.of(new SimpleGrantedAuthority(role.name()));
	}

	/**
	 * Indica si la cuenta del usuario ha expirado.
	 * En este caso, siempre se retorna true, indicando que la cuenta no expira.
	 */
	@Override
	 ...
	 * En este caso, siempre se retorna true, indicando que la cuenta no está bloqueada.
	 */
	@Override
	 ...
	 * En este caso, siempre se retorna true, indicando que las credenciales no expiran.
	 */
	@Override
	 ...
	 * En este caso, siempre se retorna true, indicando que el usuario está habilitado.
	 */
	@Override
