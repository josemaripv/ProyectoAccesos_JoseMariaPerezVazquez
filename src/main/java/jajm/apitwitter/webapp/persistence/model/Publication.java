...
/**
 * Clase que representa una publicación en la base de datos.
 * Almacena información sobre la publicación, como el usuario que la realizó, el texto, y las fechas de creación y edición.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class Publication {
    ...
    /**
     * Constructor que acepta el usuario, el texto, y las fechas para crear una nueva publicación.
     *
