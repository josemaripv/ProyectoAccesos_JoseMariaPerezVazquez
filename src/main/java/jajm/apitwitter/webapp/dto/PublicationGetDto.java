...
/**
 * Interfaz de transferencia de datos (DTO) para obtener información de publicaciones.
 * Define métodos para acceder a los atributos de una publicación.
 */
public interface PublicationGetDto {
